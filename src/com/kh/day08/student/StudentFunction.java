...
public class StudentFunction {
	...
	public void printScore() {
		for(int i = 0; i < students.length; i++) {
			...
			System.out.println("1차 점수: " + students[i].getFirstScore() +"점"+ ", 2차 점수: " +students[i].getSecondScore()+"점" +"입니다.");
		}
	}
	public void checkPass() {
		...
		// 평균이 60점 아닌 사람
		// case1. 둘다 60점이 아닌 경우
		// case2. 1차는 60점 이상 2차는 60점 이하
		// case3. 1차는 60점 이하 2차는 60점 이상
		for (int i = 0; i < students.length; i++) {
			...
			System.out.println((i+1) +"번째,"+students[i].getName()+ " 학생의 확인 결과");
				if (avg >= 60) {
					...
					if (num1 < 40) {
						System.out.println("1차 시험 재평가 대상자");
					} else if (num2 < 40) {
						System.out.println("2차 시험 재평가 대상자");
					}
		...
		if(num1 < 40) {
			...
			if(num1 < 60) {
				...
				System.out.println("2차 시험 대평가 대상");
			}
		}*/
	}
