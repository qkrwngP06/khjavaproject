...
public class Run {
	public static void main(String [] args) {
		...
		person.walking();
		*/
		//person.name = "일용자";  //private는 접근이 안됨
		//person.jobName = "의사"; //public는 접근 가능
		...
		//참조 변수 선언
		//주소가 저장되는 변수
		Rectangle rect = new Rectangle();  //객체생성, 반드시 new 키워드 이용(오른쪽)
		 								  // new는 객체의 생성자 호출
		System.out.print("너비를 입력해주세요.");
		//객체의 멤버 접근 (멤버의 종류로는 멤버 변수(필드에 있는거)와 멤버 메소드)
